...
hearth is organized around a **home page** that summarizes what needs attention, with full views for each feature area.
...
Everything in hearth is visible to everyone in the household. There are no private notes, hidden lists, or per-user data views.

Write as if you're pinning something to the kitchen board — everyone will see it.

## Quick capture philosophy

Adding something should feel like writing on a sticky note:

- No required fields beyond the essential content
- No categories or due dates unless you choose to add them
- Items can sit idle for months without feeling "overdue"
